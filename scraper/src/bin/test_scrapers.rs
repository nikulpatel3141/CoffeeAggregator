...
async fn main() -> Result<()> {
    ...
    let roasters = vec![
        ...
        ("Volcano Coffee", "https://volcanocoffeeworks.com/collections/coffee"),
        ("Union Coffee", "https://unionroasted.com/collections/coffee"),
        ("Balance Coffee", "https://www.balancecoffee.co.uk/collections/coffee"),
    ];
