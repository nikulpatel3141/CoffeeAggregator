...
export default function ReadmeTab() {
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-surface rounded-surface shadow-raised p-8 border border-border">
        <h2 className="text-3xl font-bold text-coffee-strong mb-6">
          About This Project
        </h2>

        <div className="prose dark:prose-invert max-w-none">
          <div className="mb-8">
            <h3 className="text-2xl font-semibold text-coffee-strong mb-3">
            ...
            <p className="text-text mb-4">
              ...
              <a
                ...
                className="text-coffee hover:underline font-medium"
              >
                Claude Code
              </a>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc list-inside text-text mb-4 space-y-2">
          ...
          <div className="mb-8">
            ...
            <div className="bg-canvas/70 rounded-surface p-6 mb-4">
              <h4 className="font-semibold text-text mb-3">Scraper Service (Rust/Axum)</h4>
            ...
            <div className="bg-canvas/70 rounded-surface p-6 mb-4">
              <h4 className="font-semibold text-text mb-3">Builder Job (Node.js)</h4>
              <p className="text-text mb-2">
            ...
            <div className="bg-canvas/70 rounded-surface p-6">
              <h4 className="font-semibold text-text mb-3">Frontend (Next.js 14)</h4>
              <p className="text-text mb-2">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div
                  key={roaster}
                  className="bg-crema/25 text-coffee-strong px-3 py-2 rounded-surface text-sm font-medium text-center"
                >
                  {roaster}
                </div>
              ))}
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-terracotta/10 border border-terracotta/30 rounded-surface p-4">
                <h4 className="font-semibold text-terracotta mb-2">🔓 Accidental Public GCP Endpoints</h4>
              ...
              <div className="bg-terracotta/10 border border-terracotta/30 rounded-surface p-4">
                <h4 className="font-semibold text-terracotta mb-2">💾 Aggressive Rust Binary Caching</h4>
                <p className="text-text text-sm">
              ...
              <div className="bg-terracotta/10 border border-terracotta/30 rounded-surface p-4">
                <h4 className="font-semibold text-terracotta mb-2">📦 Vercel Build Cache Nightmare</h4>
                <p className="text-text text-sm">
              ...
              <div className="bg-terracotta/10 border border-terracotta/30 rounded-surface p-4">
                <h4 className="font-semibold text-terracotta mb-2">🔄 Builder Cloning Wrong Repo</h4>
                <p className="text-text text-sm">
              ...
              <div className="bg-terracotta/10 border border-terracotta/30 rounded-surface p-4">
                <h4 className="font-semibold text-terracotta mb-2">☕ Filtering "Filter Roast" Coffees</h4>
                <p className="text-text text-sm">
              ...
              <div className="bg-terracotta/10 border border-terracotta/30 rounded-surface p-4">
                <h4 className="font-semibold text-terracotta mb-2">🔐 Attempted Push to Protected Main Branch</h4>
                <p className="text-text text-sm">
          ...
          <div className="border-t border-border pt-6">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 bg-coffee-strong bg-elevated text-white rounded-surface hover:bg-coffee hover:bg-elevated transition-surface duration-calm ease-gentle"
              >
